...
STRINGS: Dict[str, Dict[str, str]] = {
    "ko": {
        ...
        "calibration_line": "캘리브레이션 선",
        "fit": "맞춤",
        "overlay": "오버레이",
        "calibration_line_mode": "캘리브레이션 선 모드",
        ...
        "manual_calibration_line": "수동 캘리브레이션 선: {length:.2f} px",
    ...
    "en": {
        ...
        "calibration_line": "Calibration Line",
        "fit": "Fit",
        "overlay": "Overlay",
        "calibration_line_mode": "Calibration line mode",
        ...
        "manual_calibration_line": "Manual calibration line: {length:.2f} px",
    ...
    "vi": {
        ...
        "calibration_line": "Đường hiệu chuẩn",
        "fit": "Vừa khung",
        "overlay": "Lớp phủ",
        "calibration_line_mode": "Chế độ đường hiệu chuẩn",
        ...
        "manual_calibration_line": "Đường hiệu chuẩn thủ công: {length:.2f} px",
